class Application
  ...
  #Create a class array called @@cart to hold any items in your cart
  @@cart = [ ]
  ...
  def call(env)
   ...
   #Or returns a message if the cart is empty
       ...
       #Create a new route called /add     
        ...
        item_value = req.params["item"]
         #Check if that item is in @@items and then add it to the cart if it is
